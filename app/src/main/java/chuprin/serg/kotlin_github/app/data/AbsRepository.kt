...
import chuprin.serg.kotlin_github.app.data.repository.CachePolicy.BOTH
import chuprin.serg.kotlin_github.app.data.repository.specification.Specification
import io.reactivex.Observable

interface AbsRepository<MODEL> {

    fun get(specification: Specification, cachePolicy: CachePolicy = BOTH()): Observable<MODEL>

    fun getAll(specification: Specification,
               cachePolicy: CachePolicy = BOTH()): Observable<List<MODEL>>
